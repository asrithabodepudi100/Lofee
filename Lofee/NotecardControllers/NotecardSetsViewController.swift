//
//  NotecardSetsViewController.swift
//  Lofee
//
//  Created by 65,115,114,105,116,104,98 on 10/2/20.
...
class NotecardSetsViewController: UIViewController, GADRewardedAdDelegate {
    //Variables
        let realm = try! Realm()
...
//View Hseirarchy Methods
    ...
    @IBAction func newSetButtonPressed(_ sender: UIButton) {
        if notecardSets != nil{
            if notecardSets!.count > 2 && notecardSets!.count % 2 != 0 &&  defaults?.bool(forKey: "premium") == false{
...
extension NotecardSetsViewController: UITableViewDelegate, UITableViewDataSource {
      func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        print (notecardSets?.count ?? 0)
